...
-- Add departmentID to Employees
UPDATE Employees SET [DepartmentID] = 1 WHERE [JobTitle] IN ('CEO', 'CTO', 'CFO')
UPDATE Employees SET [DepartmentID] = 2 WHERE [JobTitle] IN ('Lead Software Engineer', 'Software Engineer', 'Junior Software Engineer')
UPDATE Employees SET [DepartmentID] = 3 WHERE [JobTitle] IN ('Lead Accountant', 'Accountant')
UPDATE Employees SET [DepartmentID] = 4 WHERE [JobTitle] IN ('Sales Lead', 'Sales Representative')
